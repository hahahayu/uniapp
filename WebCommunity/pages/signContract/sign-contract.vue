		...
		<view>
			<scroll-view scroll-y="true">
				<view class="contract-content">
					<!-- v-if="contractImg" -->
					<view class="contract">
						<image class="contract-img" :src="contractImg" mode="" lazy-load="true"></image>
		...
		<view class="pop" v-show="isShow">
			...
			<view class="pop-box" :animation="animationData">
				<view class="pop-content">
					...
					<view class="pop-list">
						<view class="pop-item" v-for="(item, index) in pathArr" :key="index" @tap="selectedImg(index)">
							<image v-if="item.pathImg" class="sign-item" :src="item.pathImg" mode=""></image>
							<image @tap="goSignin(index)" v-else class="item-img" src="../../static/imgs/add.png"
								mode=""></image>
							<image v-if="item.isChecked" class="check-img" src="../../static/imgs/checkImg.png" mode="">
							</image>
						</view>
					</view>
					<view class="pop-btn">
...
<script>
	...
	import {protocolInfo,signClassProtocol} from "@/servies/api.js"
	...
	export default {
		...
		methods: {
			...
			goSignin(index) {
				...
				uni.navigateTo({
					url: "/pages/signCanvas/sign-canvas",
				});
			},
			// 选中的图片
			selectedImg(index) {
